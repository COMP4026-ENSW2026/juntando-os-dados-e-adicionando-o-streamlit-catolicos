...
st.markdown("# Bruno Marqueze")
st.sidebar.markdown("# Importando dados Imobiliária Veneza")
...
for i in imoveis:
    ...
    progresso += (1/qtd) * 100
    my_bar.progress(round(progresso))

    dados = [(link, valor, descricao, quartos, area, vagas)]
    for d in dados:
        obj = {
            'url': d[0],
